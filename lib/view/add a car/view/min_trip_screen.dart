...
class MinTripScreen extends StatelessWidget {
  const MinTripScreen({super.key});
                              ...
                              controller.min.map((type) {
                                return Directionality(
                                  ...
                                  child: RadioListTile<String>(
                                    ...
                                    value: type,
                                    groupValue: controller.mingroup,
                                    activeColor: AppColors.primary,
                                    onChanged: controller.onChangedMin,
                                  ),
                                );
                              }).toList(),
                        ),
